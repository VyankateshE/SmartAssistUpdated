...
const logger = winston.createLogger({
  ...
  transports: [
    ...
    new DailyRotateFile({
      filename: path.join(__dirname, "../../RPA-logs", "info-%DATE%.log"),
    ...
    new DailyRotateFile({
      filename: path.join(__dirname, "../../RPA-logs", "error-%DATE%.log"),
      datePattern: "YYYY-MM-DD",
      level: "error",
      zippedArchive: false,
      maxSize: "20m",
    ...
    // Optional console transport for immediate feedback in the console
